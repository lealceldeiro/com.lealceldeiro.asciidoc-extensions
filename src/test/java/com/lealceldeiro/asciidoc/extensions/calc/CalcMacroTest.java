  ...
  static Stream<Arguments> calculateSrc() {
    return Stream.of(
        arguments(Operator.SUM,
                  ...
                  "4.00"),
        arguments(Operator.SUM,
                  Map.of("0", "not a number", "1", "2"),
                  InvalidValue.NOT_A_NUMBER),
        arguments(Operator.SUM,
                  Map.of(Macro.Key.MODE, Macro.Value.IGNORE_INVALID, "0", "2", "1", "2"),
                  "4.00"),
        arguments(Operator.SUM,
        ...
        arguments(Operator.SUM,
                  Map.of("0", "0.471",
                         "1", "0.49"),
                  "0.96",
                  Macro.Key.ROUNDING_MODE, null),
        arguments(Operator.SUM,
                  Map.of("0", "0.471",
                         "1", "0.49"),
                  "0.96",
                  Macro.Key.ROUNDING_MODE, "invalid"),
        arguments(Operator.SUM,
                  Map.of("0", "0.471",
                         "1", "0.49",
